...
# Input dari pengguna
uang_saku = st.number_input("Masukkan uang saku bulanan:", min_value=0, step=1000)
target_tabungan = st.number_input("Masukkan target tabungan:", min_value=0, step=1000)
